...
hdfs dfs -put ./effective_care_noH.csv /user/w205/hospital_compare
hdfs dfs -put ./hospitals_noH.csv /user/w205/hospital_compare
hdfs dfs -put ./measures_noH.csv /user/w205/hospital_compare
hdfs dfs -put ./readmissions_noH.csv /user/w205/hospital_compare
hdfs dfs -put ./surveys_responses_noH.csv /user/w205/hospital_compare
